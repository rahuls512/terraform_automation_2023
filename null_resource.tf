resource "null_resource" "provisioner" {
  ...
  connection {
    ...
    type        = "ssh"
    user        = "ec2-user"
    private_key = file("${path.module}/../Downloads/awskey5.pem")
  }
  ...
  provisioner "file" {
    content     = file("${path.module}/../Downloads/awskey5.pem")
    destination = "/home/ec2-user/mykey01"
  ...
  provisioner "remote-exec" {
    inline = [
      "chmod 400 /home/ec2-user/mykey01"
    ]
  }
